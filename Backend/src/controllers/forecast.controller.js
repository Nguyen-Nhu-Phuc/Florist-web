...
const forecastController = {
    ...
    predict: async (req, res) => {
        try {
            // Kiểm tra xem body của yêu cầu có chứa chunk không
            ...
            // // Lấy chuỗi base64 từ body của yêu cầu
            // const base64String = await req.body.chunk;

            // const base64Data = await base64String;
            // // const base64Data = base64String.replace(/^data:image\/\w+;base64,/, '');


            // // Chuyển chuỗi base64 thành dữ liệu buffer
            // const buffer = await Buffer.from(base64Data, 'base64');


            // const prepare_list = await forecastController.prepare(buffer) // Corrected here
